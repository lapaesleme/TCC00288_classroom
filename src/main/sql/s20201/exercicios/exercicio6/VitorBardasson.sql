...
DROP FUNCTION linearcombination (m integer, n integer, c1 integer, c2 integer, matrix float[][]);/*A função não retornará nenhum valor, apenas modificará a matriz original*/
